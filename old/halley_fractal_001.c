...
static const double x_min = -0.005 + 0.022;
static const double x_max =  0.005 + 0.022;
static const double y_min = -0.005;
static const double y_max =  0.005;
...
int main(void)
{
    ...
    fp = fopen("halley_fractal_001.ppm", "w");
