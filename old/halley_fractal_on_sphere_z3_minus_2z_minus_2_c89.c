 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draw the Halley fractal for the polynomial z^3 - 2z - 2, and wrap the *
...
int main(void)
{
    ...
    /*  The allowed error when searching for a root. This is the              *
    ...
    /*  The Julia set are points that don't converge. Draw these points black.*/
    ...
    FILE *fp = fopen("halley_fractal_sphere_z3_minus_2z_minus_1.ppm", "w");
