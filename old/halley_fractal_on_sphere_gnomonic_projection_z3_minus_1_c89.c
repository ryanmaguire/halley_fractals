 ...
 *                                  LICENSE                                   *
 ******************************************************************************
 *  This file is part of halley_fractals.                                     *
 *                                                                            *
 *  halley_fractals is free software: you can redistribute it and/or          *
 *  modify it under the terms of the GNU General Public License as published  *
 *  by the Free Software Foundation, either version 3 of the License, or      *
 *  (at your option) any later version.                                       *
 *                                                                            *
 *  halley_fractals is distributed in the hope that it will be useful         *
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of            *
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the             *
 *  GNU General Public License for more details.                              *
 *                                                                            *
 *  You should have received a copy of the GNU General Public License         *
 *  along with halley_fractals.  If not, see <https://www.gnu.org/licenses/>. *
 ******************************************************************************
 *  Purpose:                                                                  *
...
/*  Function for computing the gnomomic projection of a point.                */
static struct complex_number gnomonic_projection(struct vector3D p)
{
    /*  Declare necessary variables.                                          */
    double factor, z;
    struct complex_number out;
    ...
    /*  The gnomonic projection projects the point (x, y, z) to the point     *
     *  (X, Y, 1). Multiply (x, y, z) by 1/z to get this point.               */
    else
    {
        factor = 1.0 / z;
        out.real = factor * p.x;
...
static struct complex_number f_prime(struct complex_number z)
{
    ...
    /*  Compute the square of z, and multiply real and imaginary parts by 3.  */
...
int main(void)
{
    ...
    FILE *fp = fopen("halley_fractal_gnomonic_z3_minus_1_c89.ppm", "w");
